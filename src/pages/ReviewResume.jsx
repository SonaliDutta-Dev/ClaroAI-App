...
const ReviewResume = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap md:flex-nowrap gap-6 text-slate-700'>
      ...
      {/* right col */}
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-[400px] max-h-[600px] overflow-y-scroll flex-grow">
        <div className='flex items-center gap-3'>
